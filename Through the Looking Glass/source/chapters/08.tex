...
\includegraphics[width=\columnwidth]{8practice}%
\caption{<Plenty of practice!> he went on repeating}
\end{sidewaysfigure}
...
\begin{bwbigpic}
	[\basicscale]
	{8downward} 
	[Alice dragged him out by the feet, and laid him in a heap on the bank] 
\end{bwbigpic}
...
\begin{bwbigpic}
	[\basicscale]
	{8crown} 
	[<And what \textit{is} this on my head?>] 
\end{bwbigpic}
