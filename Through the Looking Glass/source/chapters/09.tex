...
\lettrine[ante=`]{W}{ell,} this \textit{is} grand!' said Alice. <I never expected I should be a Queen so soon—and I'll tell you what it is, your majesty,> she went on in a severe tone (she was always rather fond of scolding herself), <it'll never do for you to be lolling about on the grass like that! Queens have to be dignified, you know!>
...
\begin{bwbigpic}
	[\basicscale]
	{9deny} 
	[<She's in that state of mind,> said the White Queen, <that she wants to deny \textit{something}>] 
\end{bwbigpic}
...
\begin{bwbigpic}
	[\basicscale]
	{9frogthumb} 
	[The Frog went nearer and rubbed it with his thumb] 
\end{bwbigpic}
...
\begin{bwbigpic}
	[\basicscale]
	{9mutton} 
	[The leg of mutton got up and made a little bow to Alice] 
\end{bwbigpic}
