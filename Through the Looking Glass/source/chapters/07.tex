...
\lettrine{T}{he} next moment soldiers came running through the wood, at first in twos and threes, then ten or twenty together, and at last in such crowds that they seemed to fill the whole forest. Alice got behind a tree, for fear of being run over, and watched them go by.
...
\includegraphics[width=\columnwidth]{7soldiers}%
\caption{She had never seen soldiers so uncertain on their feet}
\end{sidewaysfigure}
...
\begin{sidewaysfigure}
\includegraphics[width=\columnwidth]{7alarm}%
\caption{<You alarm me!> said the King. <I feel faint—Give me a ham sandwich!>}
\end{sidewaysfigure}
