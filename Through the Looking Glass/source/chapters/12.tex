...
\lettrine[ante=`]{Y}{our} majesty shouldn't purr so loud,' Alice said, rubbing her eyes, and addressing the kitten, respectfully, yet with some severity. <You woke me out of oh! such a nice dream! And you've been along with me, Kitty—all through the Looking-Glass world. Did you know it, dear?>
...
\includegraphics[width=\columnwidth]{12kitten}%
\caption{<Now, Kitty!> she cried, clapping her hands triumphantly.}
\end{sidewaysfigure}
...
\begin{letter}
\centerline{\includegraphics[width=0.4\textwidth]{dne}}
\end{letter}

\begin{a4}
	\begin{tikzpicture}[remember picture, overlay]  
		\node (theend) at ($(current page.south)+(0cm,4.25cm)$) {\includegraphics[width=0.4\textwidth]{dne}};
	\end{tikzpicture}
\end{a4}
