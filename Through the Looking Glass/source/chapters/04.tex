...
\includegraphics[width=\columnwidth]{4dance}%
\caption{The next moment they were dancing round in a ring}
\end{sidewaysfigure}
...
\begin{bwbigpic}
	[\basicscale]
	{4grand} 
	[<If this were only cleared away,> they said, <it \textit{would} be grand!>] 
\end{bwbigpic}
...
\begin{sidewaysfigure}
\includegraphics[width=\columnwidth]{4oyster}%
\caption{The eldest Oyster winked his eye, and shook his heavy head}
\end{sidewaysfigure}
...
<But it isn't old!> Tweedledum cried, in a greater fury than ever. <It's new, I tell you—I bought it yesterday—my nice \textsc{new RATTLE}!> and his voice rose to a perfect scream.
