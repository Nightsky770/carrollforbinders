...
% \centering
% \includegraphics[width=0.4\textwidth]{stretchalice}
% \end{wrapfigure}


%What if \wrapfig, but also shitty and fragile? (It's a tikz node and a narrow minipage side by side.)
\begin{letter}
	\begin{tikzpicture}[remember picture, overlay]  
		\node[anchor=center] (pix) at ($(current page.west)+(4.25cm,0.25cm)$) {\includegraphics[width=.45\textwidth]{stretchalice}};
	\end{tikzpicture}
...
\begin{a4}
	\begin{tikzpicture}[remember picture, overlay]  
		\node[anchor=center] (pix) at ($(current page.west)+(4.25cm,0.75cm)$) {\includegraphics[width=.4\textwidth]{stretchalice}};
	\end{tikzpicture}
...
%end of man's defiance of God and righteousness
