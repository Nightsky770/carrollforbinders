...
\lettrine[findent=2pt]{A}{lice} was beginning to get very tired of sitting by her sister on the bank, and of having nothing to do: once or twice she had peeped into the book her sister was reading, but it had no pictures or conversations in it, <and what is the use of a book,> thought Alice, <without pictures or conversations?>
...
\begin{letter}	
	...
	\begin{tikzpicture}[remember picture, overlay,shift=(current page.north west)]
		\node (img) at ($(current page.center)+(0.2,-1.8cm)$) {\includegraphics[width=\textwidth]{imlate}};
...
\begin{a4}
	...
	\centering
	\begin{tikzpicture}[remember picture, overlay,shift=(current page.north west)]
		\node (img) at ($(current page.center)+(0.5cm,-1.5cm)$) {\includegraphics[width=\textwidth]{imlate}};
