...
\lettrine[ante=`]{I}{} should see the garden far better,' said Alice to herself, <if I could get to the top of that hill: and here's a path that leads straight to it—at least, no, it doesn't do that\longdash> (after going a few yards along the path, and turning several sharp corners), <but I suppose it will at last. But how curiously it twists! It's more like a corkscrew than a path! Well, \textit{this} turn goes to the hill, I suppose—no, it doesn't! This goes straight back to the house! Well then, I'll try it the other way.>
...
\begin{bwbigpic}
	[\basicscale]
	{2tigerlily} 
	[<We \textit{can} talk,> said the Tiger-lily] 
\end{bwbigpic}
...
\includegraphics[width=\columnwidth]{2chessboard}%
\caption{<I declare it's marked out just like a large chessboard!> Alice said at last}
\end{sidewaysfigure}
